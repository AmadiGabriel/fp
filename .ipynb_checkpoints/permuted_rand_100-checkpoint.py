...
def iter_random(i):
        # Initialise LightGradientBoost Classifier
    lgbm = LGBMClassifier(random_state = random.randrange(1, 10**10), n_jobs=-1, colsample_bytree=0.95)
...
# %%
lgbm_fi_iter_Problem_FPs_permuted_rand_2
...
plt.grid(axis='both')
plt.tight_layout()
plt.savefig(f'permuted_100.png', dpi=500, bbox_inches='tight')
# plt.show()
