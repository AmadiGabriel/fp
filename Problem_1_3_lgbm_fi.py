...
df_lgbm_fi = pd.DataFrame(maxrow_Problem_FD).transpose()

lgbm_fi = 'lgbm_fi_Problem_FD.csv'
df_lgbm_fi.to_csv(lgbm_fi, index=False)
...
df_maxrow_Problem_FP = pd.DataFrame(maxrow_Problem_FP).transpose()
lgbm_fi_FP = 'lgbm_fi_Problem_FP.csv'
df_lgbm_fi.to_csv(lgbm_fi_FP, index=False)
...
df_maxrow_Problem_FPs = pd.DataFrame(maxrow_Problem_FPs).transpose()
lgbm_fi_FPs = 'lgbm_fi_Problem_FPs.csv'
df_lgbm_fi.to_csv(lgbm_fi_FPs, index=False)
